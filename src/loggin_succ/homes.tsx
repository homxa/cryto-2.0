  ...
  return (
    <div className="bg-black text-white min-h-screen font-sans">
      ...
      <div className="container mx-auto p-8">
        <p className="text-lg mb-4 text-gray-400">Note: To be eligible for the exclusive airdrop, you must be actively using our app. Users not actively using the app may be filtered as bots.</p>
      </div>
      <div className="container mx-auto p-4 md:p-8">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 header">Welcome back to Crypto Sphere!</h1>
        <p className="text-lg mb-4">Crypto Sphere is your go-to destination for the latest trends and opportunities in the world of cryptocurrency. Stay updated with the most recent market trends, discover exciting airdrop opportunities, and learn about cryptocurrencies whether you're a newbie or an experienced investor.</p>
